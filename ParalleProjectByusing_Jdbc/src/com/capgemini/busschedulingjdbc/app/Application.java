...
package com.capgemini.busschedulingjdbc.app;
...
import com.capgemini.busschedulingjdbc.exceptions.DeletionFailedException;
import com.capgemini.busschedulingjdbc.exceptions.LoginFailedException;
import com.capgemini.busschedulingjdbc.exceptions.RegistrationFailedException;
import com.capgemini.busschedulingjdbc.service.AdminServices;
import com.capgemini.busschedulingjdbc.service.AdminServicesImplementation;
import com.capgemini.busschedulingjdbc.service.CommonServices;
import com.capgemini.busschedulingjdbc.service.CommonServicesImplementation;
import com.capgemini.busschedulingjdbc.service.CustomerServices;
import com.capgemini.busschedulingjdbc.service.CustomerServicesImplementation;
import com.capgemini.busschedulingjdbc.service.OwnerServices;
import com.capgemini.busschedulingjdbc.service.OwnerServicesImplementation;
import com.capgemini.busschedulingjdbc.util.Validation;
				...
				try {
					...
					case ("A"):
						while (a > 0) {
							...
							System.out.print("Enter your choice :");
							int adminInput = Integer.parseInt(scanner.next());
							if (adminInput == 1) {
								registrationUser();
					...
					case ("O"):
						while (a > 0) {
							...
							System.out.print("Enter your choice :");
							int ownerInput = Integer.parseInt(scanner.next());
							if (ownerInput == 1) {
								addBus();
